...
import pagePaginationSaga from "./pagePagination/pagePagination.saga";
import tvSeriesElementSaga from "./tvSeriesElement/tvSeriesElement.saga";

export default function* rootSaga() {
  yield all([call(movieSaga), call(tvSeriesSaga), call(movieElementSaga), call(pagePaginationSaga), call(tvSeriesElementSaga)]);
